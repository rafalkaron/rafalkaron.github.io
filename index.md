...
I mainly use Node.js to initialize local development environments for frameworks such as Gatsby or Docusaurus, build packages, and deploy builds.
...
HTML
: I am proficient in semantic HTML5.

CSS
: I am skilled in using CSS for styling different media, including: basic websites, web apps, printed media (PDFs).
...
I am experienced in styling Docusaurus sites, extending Docusaurus functionalities, and modifying the sites behavior.
